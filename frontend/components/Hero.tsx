...
export default function Hero() {
  return (
    <section className="bg-gradient-to-br from-blue-50 via-white to-cyan-50">
      <div className="mx-auto flex min-h-[85vh] max-w-7xl flex-col-reverse items-center justify-between px-8 py-20 lg:flex-row">
        ...
        <div className="max-w-xl">
          ...
          <div className="mt-12 flex items-center gap-4 rounded-xl border bg-white p-4 shadow">
